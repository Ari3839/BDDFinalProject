...
-- @Fecha   07/dic/2023
-- @Descripcion: Manejo de datos blob en select

create or replace view laptop as
  select q1.laptop_id,q1.num_serie,cantidad_ram,caracteristicas_extras,
  ...
  from (
    ...
    select laptop_id,num_serie,cantidad_ram,caracteristicas_extras,
      ...
      tipo_monitor_id,laptop_reemplazo_id
    from laptop_f5
) q1 join laptop_f1 f1 on q1.laptop_id=f1.laptop_id;
