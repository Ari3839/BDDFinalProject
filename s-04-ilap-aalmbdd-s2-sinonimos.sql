...
--Locales
create or replace synonym sucursal_f4 for sucursal_f4_aalm_s2;
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_aalm_s2;
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_aalm_s2;
create or replace synonym servicio_laptop_f4 for servicio_laptop_f4_aalm_s2;
create or replace synonym status_laptop for status_laptop_aalm_s2;
create or replace synonym laptop_f1 for laptop_f1_aalm_s2;
create or replace synonym laptop_f3 for laptop_f3_aalm_s2;
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_aalm_s2;
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_aalm_s2;
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_aalm_s2;
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_aalm_s2;
--AALMBDD_S1
...
create or replace synonym tipo_procesador_r2 for tipo_procesador_r_aalm_s1@aalmbdd_s1;
create or replace synonym tipo_tarjeta_video_r2 for tipo_tarjeta_video_r_aalm_s1@aalmbdd_s1;
create or replace synonym tipo_almacenamiento_r2 for tipo_almacenamiento_r_aalm_s1@aalmbdd_s1;
create or replace synonym tipo_monitor_r2 for tipo_monitor_r_aalm_s1@aalmbdd_s1;
--AMHBDD_S1
